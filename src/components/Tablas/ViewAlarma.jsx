...
import AddAlarma from '../Form/AddAlarma'
...
function ViewAlarma() {
  ...
  return (
    <>
        ...
        <table className="w-full table-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            ...
            <td class="w-4 p-4">
              ...
              >
                <div className="ps-3">
                  <div className="text-base font-semibold">Alarma 1</div>
                </div>
              </th>
        ...
        <AddAlarma isVisible={isVisible} toggleVisibility={toggleVisibility} onClick={toggleVisibility} />
    </>
  )
}

export default ViewAlarma